...
*/
	...
	$client->redirect_uri = 'http://'.$_SERVER['HTTP_HOST'].'/index.php';


	$client->client_id = '733502788538.apps.googleusercontent.com'; $application_line = __LINE__;
	$client->client_secret = 'NA3OOzfamm_zG2fkJe9Lex1e';
